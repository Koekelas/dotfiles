...
* EXWM
:PROPERTIES:
:header-args:sh: :tangle stow/emacs/.config/exwm/exwmrc :shebang #!/bin/bash
:END:

Set pointer cursor. For cursor names, contrary to what the man page
says, see [[file:/usr/include/X11/cursorfont.h][cursorfont.h]].
