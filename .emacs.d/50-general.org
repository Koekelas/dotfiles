...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package flx                        ; Optional dependency
    :ensure t
    :defer t)

  (use-package wgrep                      ; Optional dependency
    :ensure t
    :defer t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package request                    ; Optional dependency
    :ensure t
    :defer t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package htmlize                    ; Optional dependency
    :ensure t
    :defer t)
#+END_SRC
