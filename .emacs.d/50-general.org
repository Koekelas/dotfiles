...
#+BEGIN_SRC emacs-lisp
  (use-package winner
    ...
    ;; Storing the window layout stores a consecutive identical layout.
    ;; Don't store the window layout when reading from the minibuffer.
...
For e-mail accounts, see [[file:90-personal.org::*E-mail%20accounts][E-mail accounts]].
...
For news feeds, see [[file:90-personal.org::*News%20feeds][News feeds]].
