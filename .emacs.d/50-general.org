    ...
    (defun koek-cpny/setup-tern-backend ()
      ...
      (setq-local company-backends
                  '((company-tern company-keywords company-files
                     :with company-yasnippet))))
    :init
    (add-hook 'js2-mode-hook #'koek-cpny/setup-tern-backend))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    ...
    (when koek-js/prefer-lsp
      (add-hook 'js2-mode-hook #'koek-lsp/js-enable))
    :delight)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package tern
    ...
    :unless koek-js/prefer-lsp
    :init
    (declare-function tern-mode "tern")
