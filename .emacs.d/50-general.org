             ...
             (rel-file-name
              (let ((file-name (buffer-file-name)))
                (if (and (projectile-project-p) file-name)
                  ...
                  (buffer-name))))
             (parts (let ((file-name (file-name-sans-extension rel-file-name)))
...
#+BEGIN_SRC emacs-lisp
  (use-package winner
    ...
    ;; When reading from the minibuffer, the window layout doesn't
    ;; change (i.e. consecutive identical layouts are stored)
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package mu4e-vars
    ...
    (defvar mu4e-hide-index-messages)
  ...
  (use-package clojure-mode
    ...
    (use-package devdocs-lookup
      ...
      (:map clojure-mode-map
       ("C-c d d" . devdocs-lookup-clojure~1.9)))
    :delight
  ...
  (use-package python
    ...
    (use-package devdocs-lookup
      ...
      (:map python-mode-map
       ...
       ("C-c d C-m" . devdocs-lookup-matplotlib~3.0)
       ("C-c d C-n" . devdocs-lookup-numpy~1.14)
       ("C-c d C-p" . devdocs-lookup-pandas~0.23)))
...
#+BEGIN_SRC emacs-lisp
  (use-package sql
    ...
    (use-package devdocs-lookup
      :bind
      (:map sql-mode-map
       ("C-c d C-p" . devdocs-lookup-postgresql~10)))
...
*** cdlatex - Assist with inserting LaTeX
