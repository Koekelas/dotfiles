...
*** geiser - Interact with Scheme process
    ...
    (let* ((theme (alist-get 'eighties color-theme-sanityinc-tomorrow-colors))
           ...
           (spec
            (map-let (alt selection orange) (append personal theme)
              `((show-paren-match :foreground unspecified :background ,alt)
                (mode-line-emphasis :foreground ,orange :slant unspecified)
                ;; whitespace-mode
                (whitespace-space    :foreground ,alt :background unspecified)
                (whitespace-hspace   :foreground ,alt :background unspecified)
                (whitespace-tab      :foreground ,alt :background unspecified)
                (whitespace-newline  :foreground ,alt :background unspecified)
