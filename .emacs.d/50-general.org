      ...
      (if git-commit-mode
          (let* ((ispell-skip-region-alist ; Looked up dynamically
            ...
            (or force
                ...
                (and result
                     ;; When nothing was corrected, character tick
...
#+BEGIN_SRC emacs-lisp
  (use-package subword
    :hook
    ((prog-mode comint-mode cider-repl-mode indium-repl-mode) . subword-mode)
    :delight)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package smartparens
    ...
    (:map smartparens-mode-map
     ...
     ("C-M-k" . sp-kill-sexp))
    :hook
    (((prog-mode comint-mode cider-repl-mode indium-repl-mode) . smartparens-mode)
...
#+BEGIN_SRC emacs-lisp
  ...
  ignored."
    ...
    (add-hook 'indium-repl-mode-hook
              (koek-cpny/make-setup-backends
               '((company-indium-repl company-keywords company-files
                  :with company-yasnippet))))
...
#+BEGIN_SRC emacs-lisp
  (use-package sql
    ...
    (define-advice sql-mode (:around (f) koek-sql/defer-whitespace-mode)
      (let ((prog-mode-hook               ; Looked up dynamically
