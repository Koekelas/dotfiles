...
** Complete text around point
When the line is indented, make the tab key complete the text around
point.
       ...
       (let* ((diff-n (1+ ediff-current-difference))
         ...
         `((,(max 0 (- (window-total-width) (string-width right)))
            (" "
             ...
             koek-ml/separator))
           ,right))))
    "List of mode line constructs shown in ediff control buffer.")
