...
#+BEGIN_SRC emacs-lisp
  ...
  CANDIDATES is an alist of pretty candidate to candidate pairs."
    ...
    (defconst koek-ys/org-languages
      '(("de-de" . ("Deutsch" "ngerman" "de_DE"))
        ("en-us" . ("English" "american" "en_US"))
        ("fr"    . ("Français" "frenchb" "fr_FR"))
        ("nl"    . ("Nederlands" "dutch" "nl_BE")))
      "Alist of Org language pairs.
  Org language pair is a cons.  Its car is a string, an Org
  language name.  Its cdr is a list of strings, a language name, a
  LaTeX language name and a Hunspell language name.")

    (fset 'koek-ys/get-language-name (apply-partially #'nth 0))
