...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (defun koek/directories (file-name &optional full)
      "Return directories below FILE-NAME.
  ...
  An org file is an agenda file when it's a child of a child
  directory of `koek/projects-dir' and its name without extension
  is equal to the name of its parent directory."
      (seq-filter
       #'file-exists-p
       (mapcar (lambda (file-name)
                 (concat file-name
