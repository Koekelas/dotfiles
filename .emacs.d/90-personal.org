...
#+BEGIN_SRC emacs-lisp
  ...
  (defconst koek/documents-dir (expand-file-name "Documenten/" koek/home-dir)
    "File name to documents directory.")

  (defconst koek/projects-dir (expand-file-name "Projecten/" koek/home-dir)
      ...
      (setq mu4e-contexts
            (list
             (make-mu4e-context
              ...
              (lambda (message)
                (when message
                  (string-match-p (rx line-start "/Personal/")
